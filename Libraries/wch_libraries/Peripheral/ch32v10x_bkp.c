...
* Version            : V1.0.0
* Date               : 2020/04/30
* Description        : This file provides all the BKP firmware(固件） functions.
*******************************************************************************/ 
#include "ch32v10x_bkp.h"
#include "ch32v10x_rcc.h"

/* BKP registers bit mask BKP注册位掩码 */

/* OCTLR register bit mask OCTLR寄存器位掩码 */
...
*      reset values. 将BKP外设寄存器反初始化为默认值
* Input          : None
* Return         : None
*******************************************************************************/	
